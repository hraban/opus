...
const (
	...
	APPLICATION_VOIP = C.CONST_APPLICATION_VOIP
	// Optimize encoding for non-voice signals like music
	APPLICATION_AUDIO = C.CONST_APPLICATION_AUDIO
	// Optimize encoding for low latency applications
	APPLICATION_RESTRICTED_LOWDELAY = C.CONST_APPLICATION_RESTRICTED_LOWDELAY
	// Auto bitrate
